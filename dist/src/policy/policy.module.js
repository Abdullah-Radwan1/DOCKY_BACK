...
const usage_policy_service_1 = require("./usage-policy.service");
...
exports.PolicyModule = PolicyModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [usage_policy_service_1.UsagePolicyService],
        exports: [usage_policy_service_1.UsagePolicyService],
    })
], PolicyModule);
